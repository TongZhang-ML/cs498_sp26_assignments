...
\begin{enumerate}
\item \textbf{Bernoulli NLL from logits (4 points).}
...
\item \textbf{KL for diagonal Gaussian vs.\ standard normal (4 points).}
...
\item \textbf{Write down the negative ELBO for one data point (2 points).}
...
Then:
\begin{enumerate}
\item \textbf{Final loss report (3 points).}
...
\item \textbf{Generated images (3 points).}
...
[final eval]
  train loss=71.875380 (nll=53.495742, kl=18.379638)
  test  loss=71.969608 (nll=53.603922, kl=18.365686)


\includegraphics[width=0.8\textwidth]{figs/vae_imgs.png}  
\end{solution}

\item \textbf{Hidden evaluation (4 points).}
