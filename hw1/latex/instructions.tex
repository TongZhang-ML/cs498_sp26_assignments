...
\item
  ...
  \item
    ...
    \item 
    You are required to submit \texttt{cnn.py} and \texttt{fcn.py}, along with the saved model weights, to the Gradescope \texttt{\hwc{}} assignment. Please ensure that the filenames of the saved model weights are not altered, as changing them may result in loss of points for that question.
