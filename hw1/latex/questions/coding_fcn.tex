...
\]
\begin{enumerate}
\item (3 points) Derive $\frac{\partial}{\partial
...
\item (3 points) Derive $\frac{\partial}{\partial \theta}\ell_{\text{lr}}(f(\theta,x),y)$.
...
\begin{enumerate}
\item (3 points) Compute the total number of trainable scalar parameters in the required MLP architecture
...
\begin{enumerate}
\item (3 points) Explain briefly why noramlization is useful, and why it
...
\item (5 points) \textbf{Optimizer implementation.}
  Implement \texttt{make\_optimizer} function.
  
\item (10 points) \textbf{Training loop implementation.}
...
\begin{enumerate}
\item (4 points) Provide table for logistic regression.
  \begin{solution}
...
\end{tabular}
  ...
  \end{solution}
\item (4 points) Provide table for least squares regression.
